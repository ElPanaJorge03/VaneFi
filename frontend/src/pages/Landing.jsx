        ...
        <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <nav style={{ padding: '2rem 10%', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    <div style={{ width: 40, height: 40, borderRadius: 12, background: 'linear-gradient(135deg, var(--color-primary), #4CAF50)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '4rem 10%', textAlign: 'center' }}>
                <span className="fade-in-up" style={{ padding: '0.5rem 1rem', borderRadius: 20, border: '1px solid rgba(177, 174, 187, 0.2)', color: 'var(--color-text-muted)', fontSize: '0.875rem', marginBottom: '2rem' }}>
                ...
                <h1 className="fade-in-up delay-1" style={{ fontSize: 'clamp(3rem, 6vw, 5rem)', lineHeight: 1.1, marginBottom: '1.5rem', maxWidth: '800px' }}>
                    ...
                    <span className="gradient-text-primary">futuro financiero</span>
                </h1>

                <p className="fade-in-up delay-2 text-muted" style={{ fontSize: '1.25rem', marginBottom: '3rem', maxWidth: '600px', lineHeight: 1.6 }}>
                ...
                <div className="fade-in-up delay-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginTop: '6rem', width: '100%', maxWidth: '1200px', textAlign: 'left' }}>
                    ...
                    <div className="card" style={{ background: 'linear-gradient(180deg, var(--color-surface), rgba(26, 107, 58, 0.3))' }}>
                        <div style={{ width: 50, height: 50, borderRadius: 16, backgroundColor: 'rgba(0, 168, 107, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
                            <TrendingUp size={24} className="text-primary" />
                        </div>
                        <h3 style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>Alertas Inteligentes</h3>
                        <p className="text-muted" style={{ lineHeight: 1.6 }}>Mantén tus gastos controlados. VaneFi te avisa automáticamente cuando estés cerca de alcanzar el 80% de tu presupuesto mensual.</p>
                    </div>
                    ...
                    <div className="card" style={{ background: 'linear-gradient(180deg, var(--color-surface), rgba(26, 107, 58, 0.3))' }}>
                        ...
                        <p className="text-muted" style={{ lineHeight: 1.6 }}>Nuestro motor analiza tu historial de consumo y proyecta un gasto estimado para que no te lleves sorpresas al final del mes.</p>
                    </div>
                    ...
                    <div className="card" style={{ background: 'linear-gradient(180deg, var(--color-surface), rgba(26, 107, 58, 0.3))' }}>
                        ...
                        <p className="text-muted" style={{ lineHeight: 1.6 }}>Define una reserva intocable de tu ingreso mensual para garantizar tu fondo de ahorro o cobertura de emergencias de forma pasiva.</p>
                    </div>

                </div>
            </main>

            <footer style={{ padding: '3rem', textAlign: 'center', color: 'var(--color-text-muted)', borderTop: '1px solid rgba(177, 174, 187, 0.1)', marginTop: '4rem' }}>
